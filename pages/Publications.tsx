...
const Publications: React.FC = () => {
  ...
  const journals = publicationsList.filter(p => p.type === 'Journal');
  const conferences = publicationsList.filter(p => p.type === 'Conference');
  const workshops = publicationsList.filter(p => p.type === 'Workshop');
  const thesis = publicationsList.filter(p => p.type === 'Thesis');
